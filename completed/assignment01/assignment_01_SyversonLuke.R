...
week1_sleep[3] # Assuming the week begins on Sunday, the index is 3.
...
total_sleep_week1 < total_sleep_week2 # Returns TRUE
...
weekdays1_mean > weekdays2_mean # Returns FALSE
