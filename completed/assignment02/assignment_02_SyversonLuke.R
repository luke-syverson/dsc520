...
file.info("~/School/Github Desktop/dsc520/data/tidynomicon")
...
# stringsAsFactors is already included in R Version 4, therefore this command isn't necessary.
# person_df2 <- (person_df1, stringsAsFactors = FALSE)
#___
